 ...
 */
namespace Ajlan\CustomCatalog\Block\Adminhtml\Product;

/**
 * Class Edit
 * @package Ajlan\CustomCatalog\Block\Adminhtml\Product
 */
class Edit extends \Magento\Backend\Block\Widget
{
    ...
    protected function _prepareLayout()
    {
        ...
        if (!$this->getProduct()->isReadonly()) {
            $this->addChild(
                ...
                [
                    'label' => __('Reset'),
                    'onclick' => 'setLocation(\'' . $this->getUrl('custom_catalog/*/*', ['_current' => true]) . '\')'
                ]
            );
        }
    ...
    {
        return $this->getUrl('custom_catalog/*/save', ['_current' => true, 'back' => null]);
    }
